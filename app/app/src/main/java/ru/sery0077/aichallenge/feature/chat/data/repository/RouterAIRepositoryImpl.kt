...
import ru.sery0077.aichallenge.feature.chat.data.network.dto.ChatStreamChunk
import ru.sery0077.aichallenge.feature.chat.data.network.dto.MessageDto
...
class RouterAIRepositoryImpl(
    ...
    override fun streamChat(messages: List<ChatMessage>, settings: RequestSettings): Flow<String> = flow {
        ...
        val model = settings.modelOverride?.ifBlank { null } ?: configRepository.getModel()
